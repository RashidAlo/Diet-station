            ...
            if t == "glasschrome" {
                ...
                for e in body["els"] as? [[String: Any]] ?? [] {
                    ...
                    els.append(GlassChromeEl(id: id, x: n("x"), y: n("y"),
                                             ...
                                             off: e["off"] as? String,
                                             ends: (e["ends"] as? NSNumber)?.doubleValue,
                                             count: (e["count"] as? NSNumber)?.intValue,
                                             from: fromRect))
                }
                ...
                NSLog("DSCHROME(pilot) role=%@ mainFrame=%d armed=[%@]",
                      ...
                      message.frameInfo.isMainFrame ? 1 : 0,
                        ...
                        wv.evaluateJavaScript(
                            ...
                            "window.DSNativeChrome && DSNativeChrome([\(ids)], { scrubMotion: true, tileRows: 2, dateWidget: 1, navGlyphs: 1, navPill: 1, couponsFab: 1, couponsPill: 1 })",
